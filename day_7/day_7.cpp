...
int64_t cal(const vector<int64_t>& ns, const vector<size_t>& ops);
bool check_calibration_with_concatenation(int64_t n, const vector<int64_t>& ns);
int64_t cal_with_concatenation(const vector<int64_t>& ns, const vector<size_t>& ops);
